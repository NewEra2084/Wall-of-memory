    ...
    >
      ...
      >
        ...
        <input
          ...
          className={`${
            isSearching ? "mb-[70px]" : "mb-[250px]"
          } bg-none border-b-2 text-[32px] border-b-[#C1A886] italic placeholder:text-white focus:outline-0 w-[872px] py-4 px-8 relative text-white after:`}
